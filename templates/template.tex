...
\def\ttitlepage{$if(titlepage)$$titlepage$$else$titlepage$endif$}
\def\ttitlepagetitletop{$if(titlepagetitletop)$$titlepagetitletop$$else$titlepagetitletop$endif$}
\def\ttitlepagesubtitletop{$if(titlepagesubtitletop)$$titlepagesubtitletop$$else$titlepagesubtitletop$endif$}
\def\ttitlepagetitlemiddle{$if(titlepagetitlemiddle)$$titlepagetitlemiddle$$else$titlepagetitlemiddle$endif$}
\def\ttitlepagesubtitlemiddle{$if(titlepagesubtitlemiddle)$$titlepagesubtitlemiddle$$else$titlepagesubtitlemiddle$endif$}
...
\def\tcontact{$if(contact)$$contact$$else$contact$endif$}
\def\tcontactid{$if(contactid)$$contactid$$else$contactid$endif$}

\def\tfooterleftlabelup{$if(footerleftlabelup)$$footerleftlabelup$$else$footerleftlabelup$endif$}
\def\tfooterleftlabeldown{$if(footerleftlabeldown)$$footerleftlabeldown$$else$footerleftlabeldown$endif$}
\def\tfooterleftup{$if(footerleftup)$$footerleftup$$else$footerleftup$endif$}
\def\tfooterleftdown{$if(footerleftdown)$$footerleftdown$$else$footerleftdown$endif$}
\def\tfootermiddleup{$if(footermiddleup)$$footermiddleup$$else$footermiddleup$endif$}
\def\tfootermiddledown{$if(footermiddledown)$$footermiddledown$$else$footermiddledown$endif$}
\def\tfooterrightlabelup{$if(footerrightlabelup)$$footerrightlabelup$$else$footerrightlabelup$endif$}
\def\tfooterrightlabeldown{$if(footerrightlabeldown)$$footerrightlabeldown$$else$footerrightlabeldown$endif$}
\def\tfooterrightup{$if(footerrightup)$$footerrightup$$else$footerrightup$endif$}
\def\tfooterrightdown{$if(footerrightdown)$$footerrightdown$$else$footerrightdown$endif$}
